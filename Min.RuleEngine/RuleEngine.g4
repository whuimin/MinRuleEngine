...
jRule
   : declarationStatementList? expressionStatement
   | declarationStatementList? ruleStatement
   ;
...
parameterDeclaration
   : baseType parameterDeclarator SEMICOLON
   ;

variableDeclaration
   : baseType variableDeclarator SEMICOLON
   ;
...
ruleStatement
   : whenThenStatement (whenThenStatement)* elseStatement
   ;

whenThenStatement
   : whenStatement thenStatement SEMICOLON
   ;
...
thenStatement
   : 'then' OPEN_PARENS expression CLOSE_PARENS
   ;

elseStatement
   : 'else' OPEN_PARENS expression CLOSE_PARENS
   ;
...
relationalExpression
   : additiveExpression ((LT | GT | OP_LT | OP_GT) additiveExpression)*
   ;
...
multiplicativeExpression
   : unaryExpression ((TIMES | DIV | PERCENT)  unaryExpression)*
   ;
...
predefinedType
   : BOOL | CHAR | DECIMAL | DOUBLE | FLOAT | INT | LONG | SHORT | STRING
   ;

baseType
   : simpleType
   | classType  // represents types: enum, class, interface, delegate, type_parameter
   ;
